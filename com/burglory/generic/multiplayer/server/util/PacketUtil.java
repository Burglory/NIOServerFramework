package com.burglory.generic.multiplayer.server.util;

import java.nio.ByteBuffer;

import com.burglory.generic.multiplayer.server.api.Packet;
import com.burglory.generic.multiplayer.server.implementation._Connection;
...
public class PacketUtil {
	...
	public static boolean isReponse(Packet request, Packet response) {
		if (request.getSource() == response.getSource())
			return false;
